...
// Internal sub-component to safely handle search params during static pre-rendering
function SearchParamHandler({ children }: { children: React.ReactNode }) {
  // Accessing searchParams triggers a need for Suspense during build
...
export default function Header() {
  ...
  return (
    <header className={styles.header}>
      {/* We wrap the whole header in a fallback so that pages using Header don't crash the prerenderer */}
      <Suspense fallback={<div className={styles.header}>Loading GaadiMotorCar...</div>}>
        <SearchParamHandler>
